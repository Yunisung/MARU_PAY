...
//        RoutingContext rc = new RoutingContextImpl(null, null, httpRequest, null);
        ...
        request.pay = new Pay();
        request.pay.tmnId = "TMN002712";
        request.vact = new Vact();
        request.vact.mchtId = "bktest003";              // 가맹점아이디
        request.vact.bankCd = "039";                    // 가상계좌 은행코드
        request.vact.account = "8008308872939";        // 가상계좌번호
