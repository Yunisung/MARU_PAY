var MARU = (function (win, doc) {
  ...
  function layerInit() {
    ...
    popOverlay.setAttribute('style', 'position:fixed;top:0;bottom:0;left:0;right:0;background: rgb(255, 255, 255);width:100%;height:100%;filter:progid:DXImageTransform.Microsoft.gradient(startColorstr=#60000000,endColorstr=#60000000);overflow:hidden !important; touch-action:none;');
    var popOverlayWrap = util.createElementById('c3pop_pop_overlay_wrap');
    popOverlayWrap.setAttribute('style', 'z-index:2147483600;position:absolute;top:0;bottom:0;left:0;right:0;overflow:hidden !important; touch-action:none;');
    ...
    doc.body.appendChild(popOverlay);
  ...
  /*==== 실행 구문 ====*/
  function init() {
    util.log('IMPORT CLIENTV2.JS FILE');
    if (util.isOldIE()) {
