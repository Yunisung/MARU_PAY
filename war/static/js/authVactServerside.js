console.log('IMPORT SERVERSIDE auchVactServerside.JS FILE');
...
var util = {
    ...
    postAjax: function(url, data, success) {
        ...
        var publickey = JSON.parse(data).publicKey;
        ...
        xhr.setRequestHeader("Authorization", publickey);
...
/* 발급받은 토큰으로 결제창 열기 */
function openAuth(config) {
    c3Config = config.c3Config;
    var widgetUri = '/api/only/auth/widget';
