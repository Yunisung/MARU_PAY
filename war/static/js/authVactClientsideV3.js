var KWON = (function (win, doc) {
    ...
    function c3pop() {
        console.log('c3pop', routeDomain + '/form/payment/onlyAuthLayoutV2');

        doc.getElementById('c3_pop_iframe').src = routeDomain + '/form/payment/onlyAuthLayoutV2';
    ...
    var util = {
        ...
        validation: function (config) {
            ...
            if(!config.authType) {
                error.code = '4002'; error.message = 'authType 필수값이 없습니다.';
                return false;
            }
    ...
    function init() {
        util.log('IMPORT authVactClientsideV3.JS FILE');
