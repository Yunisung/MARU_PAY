...
//		super.setRecord("trxId", ioMap.getString("trxId"));
	 ...
	 * OSC : 1일 인증횟수
	 */
	public int getTotalAuthDayCnt(String authType, String regDay, String bankCd, String bankAccount) {
	...
	public SharedMap<String,Object> getVactTransferKey(String account, String encTransferKey) {
		super.setTable("PG_VACT_TRANSFER_KEY");
		super.setColumns("*");
		super.addWhere("account", account, eq);
		super.addWhere("transferKey", encTransferKey, eq);
	...
	public boolean existsVactTransferKey(String account) {
		super.setTable("PG_VACT_TRANSFER_KEY");
		super.setColumns("*");
		super.addWhere("account", account, eq);
	...
	public boolean existsVactTransferKey(String account, String encTransferKey) {
		super.setTable("PG_VACT_TRANSFER_KEY");
		super.setColumns("*");
		super.addWhere("account", account, eq);
		super.addWhere("transferKey", encTransferKey, eq);
	...
	public long getRentMonthSum(String month, String mchtId, String billingType) {
	...
	public long getRentBeforeSum(String mchtId, String billingType) {
		super.setTable("VW_TRX_CAP");
		super.setColumns("SUM(amount) as totAmount");
		super.addWhere("mchtId", mchtId, eq);
		//super.addWhere("capType", "매입", eq);
	...
	public int getPersonalAccount(String holderName, String identity, String bankCd, String mchtId) {
		int count = 0;

		String query = "SELECT COUNT(*) as cnt"
				+ "  FROM PG_VACT_REG "
				+ " WHERE holderName = ? and identity = ? AND bankCd = ? AND mchtId = ?";
