...
public class PAYUNIT {
	...
	public static final String PAY_HOST_LIVE 		= "api.ghpayments.kr";
	public static final String PAY_HOST_DEV 		= "api.ghpayments.kr";
...
//	public static String API_CHECK					= "/api/check";
	...
	public static String API_NAVER_P_RETURN			= "/api/naverp/return";
