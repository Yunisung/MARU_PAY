...
public class TemplateUtil {
	...
	public static void naverPayResultPage(RoutingContext rc, SimplePayResult naverRes) {
		String returnPage =
				"<html>\n" +
						"<head>\n" +
						"<title>KSPay</title>\n" +
						...
						"<tr>\n" +
						"\t<td>거래종류 :</td>\n" +
						"\t<td>"+naverRes.rApprovalType +"</td>\n" +
						"</tr>\n" +
						"<tr>\n" +
						"\t<td>거래번호 :</td>\n" +
						"\t<td>"+naverRes.rTransactionNo +"</td>\n" +
						"</tr>\n" +
						"<tr>\n" +
						"\t<td>거래성공여부 :</td>\n" +
						"\t<td>"+naverRes.rStatus+"</td>\n" +
						"</tr>\n" +
						"<tr>\n" +
						"\t<td>거래시간 :</td>\n" +
						"\t<td>"+naverRes.rTradeDate+"&nbsp;"+naverRes.rTradeTime+"</td>\n" +
						"</tr>\n" +
						"<tr>\n" +
						"\t<td>발급사코드 :</td>\n" +
						"\t<td>"+naverRes.rIssCode+"</td>\n" +
						"</tr>\n" +
						"<tr>\n" +
						"\t<td>매입사코드 :</td>\n" +
						"\t<td>"+naverRes.rAquCode+"</td>\n" +
						"</tr>\n" +
						"<tr>\n" +
						"\t<td>승인번호 :</td>\n" +
						"\t<td>"+naverRes.rAuthNo+"</td>\n" +
						"</tr>\n" +
						"<tr>\n" +
						"\t<td>메시지1 :</td>\n" +
						"\t<td>"+naverRes.rMessage1+"</td>\n" +
						"</tr>\n" +
						"<tr>\n" +
						"\t<td>메시지2 :</td>\n" +
						"\t<td>"+naverRes.rMessage2+"</td>\n" +
						"</tr>\n" +
						"</table>\n" +
						"</tr>\n" +
						"</table>\n" +
