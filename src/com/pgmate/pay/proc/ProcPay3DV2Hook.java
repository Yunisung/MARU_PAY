 ...
 *
 */
public class ProcPay3DV2Hook extends Proc {
	private static Logger logger 				= LoggerFactory.getLogger( com.pgmate.pay.proc.ProcPay3DV2Hook.class );
	private SharedMap<String,Object> ioMap =  null;
	private String trxId		= "";
	private String reCnclType		="";
	public ProcPay3DV2Hook() {
	}
	...
	public void exec(RoutingContext rc,Request request,SharedMap<String,Object> sharedMap,SharedMap<String,SharedMap<String,Object>> sharedObject) {
		...
		String search = sharedMap.getString(PAYUNIT.URI).replaceAll(PAYUNIT.API_3DV2_HOOK+"/", "");
		logger.info("3DV2HOOK : [{}]",search);
...
//		ioMap.put("amount", widgetMap.getLong("amount"));
	...
	public static void main(String[] args){
		...
		new ProcPay3DV2Hook().setTrx(ioMap);
	}
