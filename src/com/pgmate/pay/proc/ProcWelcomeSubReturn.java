...
public class ProcWelcomeSubReturn extends Proc{
    private static Logger logger 				= LoggerFactory.getLogger( ProcWelcomeSubReturn.class );
    private SharedMap<String,Object> ioMap =  null;
    private String trxId		= "";

    public ProcWelcomeSubReturn() {
    ...
    public void exec(RoutingContext rc, Request request, SharedMap<String, Object> sharedMap, SharedMap<String, SharedMap<String, Object>> sharedObject) throws Exception {
        ...
        String search = sharedMap.getString(PAYUNIT.URI).replaceAll(PAYUNIT.API_WELCOME_SUB_RETURN+"/", "");
        logger.info("WELCOME SUB RETURN : [{}]",search);
