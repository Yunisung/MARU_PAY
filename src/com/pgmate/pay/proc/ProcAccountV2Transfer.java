...
public class ProcAccountV2Transfer extends Proc{
    private static Logger logger 				= LoggerFactory.getLogger( ProcAccountV2Transfer.class );

    public ProcAccountV2Transfer() {
