...
public class Allat implements Van{
	...
	private String sShopId 					= "winnersshop";
	private String sCrossKey				= "5ffddc788801dba21c1ff5293f10bb8f";
	private String VAN					= "ALLAT";
	...
	public HashMap<String, Object> approvalReq(String strReq, String sslFlag){
		...
		try {
			...
			if( sslFlag.equals("SSL") ){
				...
				//KJM : ssl 미사용의 경우 송신 데이터 확인 후 서버와 통신 함
