...
public class KSPayApprovalCancelBean {
                    ...
                    String pFiller)     // 예비
    {
        ...
        TmpHeadMsg.append(format(pEncType, 1, 'X'));
        TmpHeadMsg.append(format(pVersion, 4, 'X'));
        TmpHeadMsg.append(format(pType, 2, 'X'));
        TmpHeadMsg.append(format(pResend, 1, 'X'));
        TmpHeadMsg.append(format(pRequestDate, 14, 'X'));
        TmpHeadMsg.append(format(pStoreId, 10, 'X'));
        TmpHeadMsg.append(format(pOrderNumber, 50, 'X'));
        TmpHeadMsg.append(format(pUserName, 50, 'X'));
        TmpHeadMsg.append(format(pIdNum, 13, 'X'));
        TmpHeadMsg.append(format(pEmail, 50, 'X'));
        TmpHeadMsg.append(format(pGoodType, 1, 'X'));
        TmpHeadMsg.append(format(pGoodName, 50, 'X'));
        TmpHeadMsg.append(format(pKeyInType, 1, 'X'));
        TmpHeadMsg.append(format(pLineType, 1, 'X'));
        TmpHeadMsg.append(format(pPhoneNo, 12, 'X'));
        TmpHeadMsg.append(format(pApprovalCount, 1, 'X'));
            ...
            String EncData)    // MPI, ISP 데이터
    {
        ...
        TmpSendMsg.append(format(ApprovalType, 4, 'X'));
        TmpSendMsg.append(format(InterestType, 1, 'X'));
        TmpSendMsg.append(format(TrackII, 40, 'X'));
        TmpSendMsg.append(format(Installment, 2, '9'));
        TmpSendMsg.append(format(Amount, 9, '9'));
        TmpSendMsg.append(format(Passwd, 2, 'X'));
        TmpSendMsg.append(format(IdNum, 10, 'X'));
        TmpSendMsg.append(format(CurrencyType, 1, 'X'));
        TmpSendMsg.append(format(BatchUseType, 1, 'X'));
        TmpSendMsg.append(format(CardSendType, 1, 'X'));
        TmpSendMsg.append(format(VisaAuthYn, 1, 'X'));
        TmpSendMsg.append(format(Domain, 40, 'X'));
        TmpSendMsg.append(format(IpAddr, 20, 'X'));
        TmpSendMsg.append(format(BusinessNumber, 10, 'X'));
        TmpSendMsg.append(format(Filler, 135, 'X'));
        TmpSendMsg.append(format(AuthType, 1, 'X'));
        TmpSendMsg.append(format(MPIPositionType, 1, 'X'));
        TmpSendMsg.append(format(MPIReUseType, 1, 'X'));
            ...
            String Filler)    // 기타
    {
        ...
        TmpSendMsg.append(format(ApprovalType, 4, 'X'));
        TmpSendMsg.append(format(BankCode, 6, 'X'));
        TmpSendMsg.append(format(Amount, 9, '9'));
        TmpSendMsg.append(format(CloseDate, 8, 'X'));
        TmpSendMsg.append(format(CloseTime, 6, 'X'));
        TmpSendMsg.append(format(EscrowSele, 1, 'X'));
        TmpSendMsg.append(format(VirFixSele, 1, 'X'));
        TmpSendMsg.append(format(VirAcctNo, 15, 'X'));
        TmpSendMsg.append(format(OrgTransactionNo, 12, 'X'));
        TmpSendMsg.append(format(Filler, 52, 'X'));
            ...
            String Filler)      // 기타
    {
        ...
        TmpSendMsg.append(format(BankCode, 6, 'X'));
        TmpSendMsg.append(format(Amount, 9, '9'));
        TmpSendMsg.append(format(Filler, 81, 'X'));
            ...
            String Filler)      // 기타
    {
        ...
        TmpSendMsg.append(format(ApprovalType, 4, 'X'));
        TmpSendMsg.append(format(TrackII + "=4912", 40, 'X'));
        TmpSendMsg.append(format(Passwd, 4, 'X'));
        TmpSendMsg.append(format(Amount, 9, '9'));
        TmpSendMsg.append(format(WorldPassType, 1, 'X'));
        TmpSendMsg.append(format(AdultType, 1, 'X'));
        TmpSendMsg.append(format(CardSendType, 1, 'X'));
        TmpSendMsg.append(format(Filler, 40, 'X'));
            ...
            String Filler)       // 기타
    {
        ...
        TmpSendMsg.append(format(Amount, 9, '9'));
        TmpSendMsg.append(format(Passwd, 4, 'X'));
        TmpSendMsg.append(format(SaleType, 2, 'X'));
        TmpSendMsg.append(format(Filler, 40, 'X'));
            ...
            String Filler)        //예비
    {
        ...
        TmpSendMsg.append(format(ApprovalType, 4, 'X'));
        TmpSendMsg.append(format(TransactionNo, 12, 'X'));
        TmpSendMsg.append(format(IssuSele, 1, 'X'));
        TmpSendMsg.append(format(UserInfoSele, 1, 'X'));
        TmpSendMsg.append(format(UserInfo, 37, 'X'));
        TmpSendMsg.append(format(TranSele, 1, 'X'));
        TmpSendMsg.append(format(CallCode, 1, 'X'));
        TmpSendMsg.append(format(SupplyAmt, 9, '9'));
        TmpSendMsg.append(format(TaxAmt, 9, '9'));
        TmpSendMsg.append(format(SvcAmt, 9, '9'));
        TmpSendMsg.append(format(TotAmt, 9, '9'));
        TmpSendMsg.append(format(Filler, 147, 'X'));
    ...
    public boolean Mobile1DataMessage(
        ...
        TmpSendMsg.append(format(ApprovalType, 4, 'X'));
        TmpSendMsg.append(format(MobileNo, 12, 'X'));
        TmpSendMsg.append(format(SocialNo, 13, 'X'));
        TmpSendMsg.append(format(UsersocialNo, 13, 'X'));
        TmpSendMsg.append(format(Commsele, 3, 'X'));
        TmpSendMsg.append(format(Filler, 155, 'X'));
    ...
    public boolean Mobile2DataMessage(
        ...
        TmpSendMsg.append(format(ApprovalType, 4, 'X'));
        TmpSendMsg.append(format(TransactionNo, 12, 'X'));
        TmpSendMsg.append(format(Smsval, 20, 'X'));
        TmpSendMsg.append(format(Filler, 164, 'X'));
    ...
    public boolean MobileAppr1DataMessage(
        ...
        TmpSendMsg.append(format(UsersocialNo, 13, 'X'));
        TmpSendMsg.append(format(Commsele, 3, 'X'));
        TmpSendMsg.append(format(ApprAmount, 9, '9'));
        TmpSendMsg.append(format(BypassMsg, 100, 'X'));
        TmpSendMsg.append(format(CompSele, 1, 'X'));
        TmpSendMsg.append(format(Filler, 145, 'X'));
    ...
    public boolean MobileAppr2DataMessage(
        ...
        TmpSendMsg.append(format(TransactionNo, 12, 'X'));
        TmpSendMsg.append(format(Smsval, 20, 'X'));
        TmpSendMsg.append(format(BypassMsg, 20, 'X'));
        TmpSendMsg.append(format(Filler, 164, 'X'));
            ...
            String Filler)        // 기타
    {
        ...
        TmpSendMsg.append(format(ApprovalType, 4, 'X'));
        TmpSendMsg.append(format(AcctSele, 1, 'X'));
        TmpSendMsg.append(format(FeeSele, 1, 'X'));
        TmpSendMsg.append(format(PareBankCode, 6, 'X'));
        TmpSendMsg.append(format(PareAcctNo, 15, 'X'));
        TmpSendMsg.append(format(CustBankCode, 6, 'X'));
        TmpSendMsg.append(format(Amount, 13, '9'));
        TmpSendMsg.append(format(InjaName, 16, 'X'));
        TmpSendMsg.append(format(Filler, 38, 'X'));
            ...
            String CertData)  // 인증정보
    {
        ...
        TmpSendMsg.append(format(BankCode, 6, 'X'));
        TmpSendMsg.append(format(Amount, 13, '9'));
        TmpSendMsg.append(format(CustBankInja, 30, 'X'));
        TmpSendMsg.append(format(BankTransactionNo, 30, 'X'));
        TmpSendMsg.append(format(Filler, 53, 'X'));
            ...
            String Filler)         // 기타
    {
        ...
        TmpSendMsg.append(format(ApprovalType, 4, 'X'));
        TmpSendMsg.append(format(CancelType, 1, 'X'));
        TmpSendMsg.append(format(TransactionNo, 12, 'X'));
        TmpSendMsg.append(format(TradeDate, 8, 'X'));
        TmpSendMsg.append(format(OrderNumber, 50, 'X'));
        TmpSendMsg.append(format(CancelData, 42, 'X'));
        TmpSendMsg.append(format(Refundcheck, 1, 'X'));
        TmpSendMsg.append(format(Filler, 32, 'X'));
            ...
            String Filler)       // 기타
    {
        ...
        TmpSendMsg.append(format(ApprovalType, 4, 'X'));
        TmpSendMsg.append(format(TrackII, 40, 'X'));
        TmpSendMsg.append(format(Filler, 56, 'X'));
            ...
            String Filler)       // 기타
    {
        ...
        TmpSendMsg.append(format(ApprovalType, 4, 'X'));
        TmpSendMsg.append(format(ShopId, 10, 'X'));
        TmpSendMsg.append(format(BusiSele, 1, 'X'));
        TmpSendMsg.append(format(CardCode, 6, 'X'));
        TmpSendMsg.append(format(Filler, 79, 'X'));
    ...
    public boolean ReceiveDataMessage(int iCnt) throws IOException {
        ...
        for (int i = 0; i < iCnt; i++) {
            ...
            if (this.ApprovalType[i].charAt(0) == '1' || this.ApprovalType[i].charAt(0) == 'I') {
                if (this.ApprovalType[i].charAt(1) == '5') {
            ...
            // 핸드폰 결제 1차 : M120
                    ...
                    this.ApprovalType[i].startsWith("M11"))    //핸드폰결제취소
            {
            ...
            // 상점상세정보 조회결과
                ...
                this.ReceiveMsg += TmpReceiveMsg.toString();
                System.out.println("ShopInfoDetail(A700) ReceiveMsg[" + i + "]" + "=[" + TmpReceiveMsg + "]");
            }
        }
        return true;
    }
    ...
    public boolean SendSocket(String Flag) {
        ...
        try {
            ...
            String pDataLen = format("" + real_send_msg.getBytes(MSG_ENCODING).length, 4, '9');
